...
<head>
    ...
    <title>Riwayat Gaji - {{ $teacher->name }}</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-table { margin-bottom: 15px; font-size: 12px; }
    ...
    <div class="page">
        ...
        <table>
            ...
            <tbody>
                ...
                @if(count($salaries) == 0)
                    <tr>
                        <td colspan="6" class="text-center">Belum ada riwayat gaji.</td>
                    </tr>
                @endif
            </tbody>
        </table>
        ...
        <div class="footer">
            <div class="signature">
                <p>{{ date('d F Y') }}<br>Pegawai yang bersangkutan</p>
                <p style="text-decoration: underline; font-weight: bold;">( {{ $teacher->name }} )</p>
            </div>
        </div>
    </div>
</body>
