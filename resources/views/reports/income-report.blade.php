...
<body>
    <div class="container">
        ...
        <div class="judul-laporan">
            <h3>Laporan Rekapitulasi Pemasukan</h3>
        ...
        <table class="tabel-formal">
            ...
            <tbody>
                @php 
                    $no = 1; 
                @endphp
                @forelse($income as $category => $items)
            ...
            <tfoot>
                <tr>
                    <th colspan="4" class="text-right">TOTAL PEMASUKAN KESELURUHAN</th>
                    <th class="text-right font-bold">Rp {{ number_format($totalIncome, 0, ',', '.') }}</th>
                </tr>
            </tfoot>
        </table>
